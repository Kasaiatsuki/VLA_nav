...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'launch'), ['launch/vla_nav.launch.py', 'launch/vla_nav_7b.launch.py']),
        (os.path.join('share', package_name, 'config'), ['config/vla_nav_node.yaml', 'config/vla_nav_7b_node.yaml']),
    ],
